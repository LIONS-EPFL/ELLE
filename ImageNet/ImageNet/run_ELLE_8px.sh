...
CONFIG1=configs/configs_ELLE-A_${NAME}_phase1.yml
CONFIG2=configs/configs_ELLE-A_${NAME}_phase2.yml
CONFIG3=configs/configs_ELLE-A_${NAME}_phase3.yml
...
END1=dir_to/ImageNet/trained_models/ELLE-A_adv_phase1_${NAME}_lambda${LAMBDA}_rep2_step8_eps8_repeat1/checkpoint_epoch6.pth.tar
END2=dir_to/ImageNet/trained_models/ELLE-A_adv_phase2_${NAME}_lambda${LAMBDA}_rep2_step8_eps8_repeat1/checkpoint_epoch12.pth.tar
END3=dir_to/ImageNet/trained_models/ELLE-A_adv_phase3_${NAME}_lambda${LAMBDA}_rep2_step8_eps8_repeat1/checkpoint_epoch15.pth.tar
